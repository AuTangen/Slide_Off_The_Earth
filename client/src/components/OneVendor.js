    ...
    const OutputVendor = ({ vendor }) => {
        ...
        return (
            <div className="one-artist-section">
                ...
                <div key={vendor._id} className="one-artist">
                    <img src={vendorimg} alt="vendor" className="w-full" />
                    {props.user && (
                        <div class='edit-delete-artist-container'>
                            <button onClick={updateForm} id='edit-artist' className="edit-artist">Update</button>
                            <button onClick={() => deleteVendor(vendor._id)} id='delete-artist' className="delete-artist">Delete</button>
